...
@Entity
@Table(name = "EXECUTETIMEREMOVE", schema = "KETTLE_USER", catalog = "")
public class ExecutetimeremoveEntity {
    private String uuid;
    ...
    public boolean equals(Object o) {
        ...
        ExecutetimeremoveEntity that = (ExecutetimeremoveEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, monthofyear, dayofmonth, numofweek, timeofday, looptime, orloop, looptype, createtime, createperson, operatorperson, spare1, spare2, spare3, executetimeuuid, deletetime, status);
    }
}
