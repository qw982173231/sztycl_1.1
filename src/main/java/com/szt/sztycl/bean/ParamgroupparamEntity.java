...
@Entity
@Table(name = "PARAMGROUPPARAM", schema = "KETTLE_USER", catalog = "")
public class ParamgroupparamEntity {
    private String uuid;
    ...
    public boolean equals(Object o) {
        ...
        ParamgroupparamEntity that = (ParamgroupparamEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, groupUuid, paramDm, paramMc, paramMs, createtime, createperson, operatorperson, spare1, spare2, spare3);
    }
}
