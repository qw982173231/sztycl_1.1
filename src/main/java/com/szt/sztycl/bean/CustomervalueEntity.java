...
@Entity
@Table(name = "CUSTOMERVALUE", schema = "KETTLE_USER", catalog = "")
public class CustomervalueEntity {
    ...
    public boolean equals(Object o) {
        ...
        CustomervalueEntity that = (CustomervalueEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, mainUuid, paramMc, paramDm, paramValue, createtime, createperson, operatorperson, spare1, spare2, spare3);
    }
}
