...
@Entity
@Table(name = "EXECUTETASKREMOVE", schema = "KETTLE_USER", catalog = "")
public class ExecutetaskremoveEntity {
    private String uuid;
    ...
    public boolean equals(Object o) {
        ...
        ExecutetaskremoveEntity that = (ExecutetaskremoveEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, executetaskMc, executetaskMs, yxbz, orabnoramal, createtime, createperson, operatorperson, spare1, spare2, spare3, executetaskuuid, deletetime, status);
    }
}
