...
@Entity
@Table(name = "PARAMGROUPGROUP", schema = "KETTLE_USER", catalog = "")
public class ParamgroupgroupEntity {
    private String uuid;
    ...
    public boolean equals(Object o) {
        ...
        ParamgroupgroupEntity that = (ParamgroupgroupEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, groupUuid, groupDm, groupMc, yxjb, createtime, createperson, operatorperson, spare1, spare2, spare3);
    }
}
