...
@Entity
@Table(name = "PARAMGROUPVALUE", schema = "KETTLE_USER", catalog = "")
public class ParamgroupvalueEntity {
    private String uuid;
    ...
    public boolean equals(Object o) {
        ...
        ParamgroupvalueEntity that = (ParamgroupvalueEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, groupUuid, groupgroupDm, groupparamDm, value, createtime, createperson, operatorperson, spare1, spare2, spare3);
    }
}
