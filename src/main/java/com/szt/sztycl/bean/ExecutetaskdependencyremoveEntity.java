...
@Entity
@Table(name = "EXECUTETASKDEPENDENCYREMOVE", schema = "KETTLE_USER", catalog = "")
public class ExecutetaskdependencyremoveEntity {
    private String uuid;
    ...
    private String executedependencyuuid;
    ...
    @Basic
    @Column(name = "EXECUTEDEPENDENCYUUID")
    public String getExecutedependencyuuid() {
        return executedependencyuuid;
    }

    public void setExecutedependencyuuid(String executedependencyuuid) {
        this.executedependencyuuid = executedependencyuuid;
    }
    ...
    public boolean equals(Object o) {
        ...
        ExecutetaskdependencyremoveEntity that = (ExecutetaskdependencyremoveEntity) o;
        return Objects.equals(uuid, that.uuid) &&
                ...
                Objects.equals(executedependencyuuid, that.executedependencyuuid) &&
                Objects.equals(deletetime, that.deletetime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(uuid, mainUuid, dependencyUuid, createtime, createperson, operatorperson, spare1, spare2, spare3, executedependencyuuid, deletetime);
    }
}
