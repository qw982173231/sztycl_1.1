...
@Entity
@Table(name = "TASKANDEXECUTETASKREMOVE", schema = "KETTLE_USER", catalog = "")
public class TaskandexecutetaskremoveEntity {
    private String uuid;
    ...
    private String taskandexecutetaskuuid;
    ...
    @Basic
    @Column(name = "TASKANDEXECUTETASKUUID")
    public String getTaskandexecutetaskuuid() {
        return taskandexecutetaskuuid;
    }

    public void setTaskandexecutetaskuuid(String taskandexecutetaskuuid) {
        this.taskandexecutetaskuuid = taskandexecutetaskuuid;
    }
    ...
    public boolean equals(Object o) {
        ...
        TaskandexecutetaskremoveEntity that = (TaskandexecutetaskremoveEntity) o;
        return Objects.equals(uuid, that.uuid) &&
                ...
                Objects.equals(taskandexecutetaskuuid, that.taskandexecutetaskuuid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, taskuuid, executetaskuuid, createtime, createperson, operatorperson, spare1, spare2, spare3, taskandexecutetaskuuid, deletetime, status);
    }
}
