...
@Entity
@Table(name = "KETTLE_TASKREMOVE", schema = "KETTLE_USER", catalog = "")
public class KettleTaskremoveEntity {
    private String uuid;
    ...
    public boolean equals(Object o) {
        ...
        KettleTaskremoveEntity that = (KettleTaskremoveEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uuid, taskMc, taskMs, yxbz, yxj, createtime, createperson, operatorperson, spare1, spare2, spare3, taskuuid, deletetime, status);
    }
}
